function ndimport(xImarisApp, ndBase, ndData, guiNd)
    % NDIMPORT MDA data import function
    %   NDIMPORT handles the parsing of the .nd file information and import
    %   of data into Imaris.
    %
    ...
    isWaveShift = sum(waveShiftValues, 2) > 0;
    ...
    for s = 1:length(stageStrImportList)
        ...
        if isempty(stageStrImportList{1})
            hStatus.setText(...
                ['Exporting ' ndBase])
